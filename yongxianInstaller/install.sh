...
# ╔═══════════════════════════════════════════════════════════════════════════╗
# ║                                                                           ║
# ║   YongXian 一键部署脚本 v1.0.0                                          ║
# ║   智能 AI 助手部署工具 - 支持多平台多模型                                    ║
# ║                                                                           ║
# ║   GitHub: https://github.com/insight68/yongxian                              ║
# ║   官方文档: https://yongxian.xyz                                        ║
# ║                                                                           ║
# ╚═══════════════════════════════════════════════════════════════════════════╝
#
# 使用方法:
...
MIN_NODE_VERSION=22
GITHUB_REPO="insight68/yongxian"
...
# 从源码构建 YongXian（使用用户指定的 GitHub 仓库）
install_from_source() {
...
install_openclaw() {
    ...
    # 从源码构建（使用用户指定的 GitHub 仓库）
    install_from_source

    # 验证安装
    if check_command openclaw; then
        log_info "YongXian 安装成功: $(openclaw --version 2>/dev/null || echo 'installed')"
        init_openclaw_config
    else
        log_error "YongXian 安装失败"
        exit 1
    fi
}
...
# 配置 YongXian 使用的 AI 模型和 API Key
configure_openclaw_model() {
    log_step "配置 YongXian AI 模型..."
...
# create_default_config 已移除 - YongXian 使用 openclaw.json 和环境变量
...
run_onboard_wizard() {
    ...
    echo ""
    echo -e "${PURPLE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${WHITE}           🧙 YongXian 核心配置向导${NC}"
    echo -e "${PURPLE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    ...
    if [ "$skip_ai_config" = false ]; then
        setup_ai_provider
        # 先配置 YongXian（设置环境变量和自定义 provider），然后再测试
        configure_openclaw_model
        test_api_connection
    else
        # 即使跳过配置，也可选择测试连接
...
test_api_connection() {
    ...
    if ! check_command openclaw; then
        echo -e "${YELLOW}YongXian 未安装，跳过测试${NC}"
        return 0
    fi
    ...
    while [ "$test_passed" = false ] && [ $retry_count -lt $max_retries ]; do
        ...
        if [ $exit_code -eq 0 ] && ! echo "$filtered_result" | grep -qiE "^error:|api error|401|403|Unknown model|超时|Incorrect API|authentication failed"; then
            test_passed=true
            echo -e "${GREEN}✓ YongXian AI 测试成功！${NC}"
            echo ""
            # 显示 AI 响应（过滤掉空行和系统日志）
            ...
            echo -e "${RED}✗ YongXian AI 测试失败 (退出码: $exit_code)${NC}"
            echo ""
...
[Unit]
Description=YongXian AI Assistant
...
# 启动 YongXian Gateway 服务
start_openclaw_service() {
    echo ""
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${WHITE}           🚀 启动 YongXian 服务${NC}"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    ...
    if [ -n "$existing_pid" ]; then
        log_warn "YongXian Gateway 已在运行 (PID: $existing_pid)"
        echo ""
    ...
    if [ -n "$gateway_pid" ]; then
        echo ""
        echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
        echo -e "${GREEN}           ✓ YongXian Gateway 已启动！(PID: $gateway_pid)${NC}"
        echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
        echo ""
...
main() {
    ...
    # 询问是否启动服务
    if confirm "是否现在启动 YongXian 服务？" "y"; then
        start_openclaw_service
    else
        echo ""
    ...
    echo ""
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${WHITE}           🖥️ 推荐：YongXian Manager 桌面版${NC}"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${WHITE}如果你更喜欢图形界面，推荐下载 YongXian Manager 桌面应用：${NC}"
    echo ""
    ...
    echo ""
    echo -e "  👉 ${PURPLE}下载地址: https://github.com/insight68/yongxian${NC}"
    echo ""
